...
targ_data = pd.read_csv(path+'/all_adv_stats_calculated/I_want_this_rerun.csv')
...
def find_lineups_stats(team,gameday):
    print('in find_lineups_stats:', gameday)
    if (home == 'OKC') & (str(gameday)[0:4] == str(2008)):
        home = 'SEA'
    elif (home == 'BKN') & (str(gameday)[0:4]  == str(2012)):
        home = 'NJN'
    elif (home == 'NOP') & (str(gameday)[0:4]  ==  str(2013)):
        home = 'NOH'
